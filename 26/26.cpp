...
public:
    ...
    Main()
    {
        ...
        m_dirLight.AmbientIntensity = 0;
        m_dirLight.DiffuseIntensity = 1;
        m_dirLight.Color = Vector3f(1.0f, 0.7f, 0.7f);
        m_dirLight.Direction = Vector3f(0.0f, 0.0f, 1);
    ...
    bool Init()
    {
        ...
        if (!m_pSphereMesh->LoadMesh("C:\\lw4\\26\\models\\box.obj")) {
            return false;
        }

        m_pTexture = new Texture(GL_TEXTURE_2D, "C:\\lw4\\26\\bricks.jpg");
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:\\lw4\\26\\normal_map.jpg");

        if (!m_pNormalMap->Load()) {
            return false;
        }

        m_pTrivialNormalMap = new Texture(GL_TEXTURE_2D, "C:\\lw4\\26\\normal_up.jpg");
